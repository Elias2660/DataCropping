...
def process_vids(original_path: str, file: str):
    ...
    path = os.path.join(
        original_path, "old", file
    )  # original_path, old created earlier
    ...
    try:
        ...
        while cap.isOpened():
            ...
            start_point_1 = ((width) // 8, 0)
            end_point_1 = (width //2, height)
...
if __name__ == "__main__":
    ...
    try:
        ...
        with concurrent.futures.ProcessPoolExecutor(
            ...
            futures = [
                executor.submit(process_vids, args.path, file) for file in file_list
            ]
